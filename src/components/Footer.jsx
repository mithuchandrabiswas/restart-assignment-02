    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div>
          ...
          <p className="ft-desc">
            CS Ticket System helps support teams manage, track, and resolve
            customer issues efficiently. Stay on top of every request — from
            open tickets to resolved cases — all in one place.
          </p>
        </div>
